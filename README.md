...
CODYJATE is a text editor that runs in the browser. Its a single page application that meets the PWA criteria. It could be useful for developers to create notes or code snippets with or without internet connection so that they could reliably retrieve them for later use.
...
![CODYJATE](https://github.com/codybronsell/cody-text-editor2/screenshot.png)
...
https://cody-text-editor.herokuapp.com/


## Questions

https://github.com/codybronsell
